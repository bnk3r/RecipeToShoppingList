...
fun provideRecipeViewModel(getRecipesForCategoryUseCase: GetRecipesForCategoryUseCase) =
    RecipeViewModel(getRecipesForCategoryUseCase)

val viewModelModule = module {
    viewModel { provideCategoryViewModel(get()) }
    viewModel { provideRecipeViewModel(get()) }
}